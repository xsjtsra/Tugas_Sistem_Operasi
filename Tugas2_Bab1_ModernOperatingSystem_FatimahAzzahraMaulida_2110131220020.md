...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A modern computer consists of one or more processors, some main memory,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Most readers will have had some experience with an operating system such as
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A simple overview of the main components under discussion here is given in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The user interface program, shell or GUI, is the lowest level of user-mode software, and allows the user to start other programs, such as a Web browser, email
reader, or music player. These programs, too, make heavy use of the operating system.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The placement of the operating system is shown in Fig. 1-1. It runs on the
bare hardware and provides the base for all the other software.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp An important distinction between the operating system and normal (usermode) software is that if a user does not like a particular email reader, he† is free to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This distinction, however, is sometimes blurred in embedded systems (which
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Also, in many systems there are programs that run in user mode but help the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems differ from user (i.e., application) programs in ways other
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp It should be clear now why operating systems live a long time—they are very
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Besides Windows, the other main example we will use throughout this book is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In this chapter we will briefly touch on a number of key aspects of operating
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp It is hard to pin down what an operating system is other than saying it is the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The <b>architecture</b> (instruction set, memory organization, I/O, and bus structure) of most computers at the machine-language level is primitive and awkward to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp But even this level is much too low for most applications. For this reason, all
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp This abstraction is the key to managing all this complexity. Good abstractions
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This point is so important that it is worth repeating in different words. With all
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp It should be noted that the operating system’s real customers are the application programs (via the application programmers, of course). They are the ones
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In this book, we will study the abstractions provided to application programs in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The concept of an operating system as primarily providing abstractions to application programs is a top-down view. An alternative, bottom-up, view holds that
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Modern operating systems allow multiple programs to be in memory and run
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When a computer (or network) has more than one user, the need for managing
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Resource management includes <b>multiplexing (sharing)</b> resources in two different ways: in time and in space. When a resource is time multiplexed, different
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The other kind of multiplexing is space multiplexing. Instead of the customers
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems have been evolving through the years. In the following sections we will briefly look at a few of the highlights. Since operating systems have
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The progression given below is largely chronological, but it has been a bumpy
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The first true digital computer was designed by the English mathematician
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As an interesting historical aside, Babbage realized that he would need software for his analytical engine, so he hired a young woman named Ada Lovelace,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After Babbage’s unsuccessful efforts, little progress was made in constructing
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In these early days, a single group of people (usually engineers) designed,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp By the early 1950s, the routine had improved somewhat with the introduction
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The introduction of the transistor in the mid-1950s changed the picture radically. Computers became reliable enough that they could be manufactured and sold
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp These machines, now called <b>mainframes</b>, were locked away in large, specially
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When the computer finished whatever job it was currently running, an operator
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Given the high cost of the equipment, it is not surprising that people quickly
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After about an hour of collecting a batch of jobs, the cards were read onto a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp it. When the whole batch was done, the operator removed the input and output
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The structure of a typical input job is shown in Fig. 1-4. It started out with a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Large second-generation computers were used mostly for scientific and engineering calculations, such as solving the partial differential equations that often occur in physics and engineering. They were largely programmed in FORTRAN and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp character-oriented, commercial computers, such as the 1401, which were widely
used for tape sorting and printing by banks and insurance companies.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Developing and maintaining two completely different product lines was an expensive proposition for the manufacturers. In addition, many new computer customers initially needed a small machine but later outgrew it and wanted a bigger
machine that would run all their old programs, but faster.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp IBM attempted to solve both of these problems at a single stroke by introducing the System/360. The 360 was a series of software-compatible machines ranging from 1401-sized models to much larger ones, more powerful than the mighty
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The IBM 360 was the first major computer line to use (small-scale) <b>ICs (Integrated Circuits)</b>, thus providing a major price/performance advantage over the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The greatest strength of the ‘‘single-family’’ idea was simultaneously its greatest weakness. The original intention was that all software, including the operating
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp There was no way that IBM (or anybody else for that matter) could write a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One of the designers of OS/360, Fred Brooks, subsequently wrote a witty and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Despite its enormous size and problems, OS/360 and the similar third-generation operating systems produced by other computer manufacturers actually satisfied most of their customers reasonably well. They also popularized several key
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The solution that evolved was to partition memory into several pieces, with a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another major feature present in third-generation operating systems was the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Although third-generation operating systems were well suited for big scientific
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This desire for quick response time paved the way for <b>timesharing</b>, a variant
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After the success of the CTSS system, M.I.T., Bell Labs, and General Electric
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp MULTICS was a mixed success. It was designed to support hundreds of users
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To make a long story short, MULTICS introduced many seminal ideas into the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp By the end of the 20th century, the concept of a computer utility had fizzled
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Despite its lack of commercial success, MULTICS had a huge influence on
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another major development during the third generation was the phenomenal
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One of the computer scientists at Bell Labs who had worked on the MULTICS
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The history of UNIX has been told elsewhere (e.g., Salus, 1994). Part of that
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As an aside, it is worth mentioning that in 1987, the author released a small
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The desire for a free production (as opposed to educational) version of MINIX
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp ith the development of <b>LSI (Large Scale Integration)</b> circuits—chips containing thousands of transistors on a square centimeter of silicon—the age of the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In 1974, when Intel came out with the 8080, the first general-purpose 8-bit
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In 1977, Digital Research rewrote CP/M to make it suitable for running on the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In the early 1980s, IBM designed the IBM PC and looked around for software
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When IBM came back, Gates realized that a local computer manufacturer,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp By the time the successor to the IBM PC, the IBM PC/AT, came out in 1983
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp CP/M, MS-DOS, and other operating systems for early microcomputers were
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One day, Steve Jobs, who co-invented the Apple computer in his garage, visited PARC, saw a GUI, and instantly realized its potential value, something Xerox
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When Microsoft decided to build a successor to MS-DOS, it was strongly
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another Microsoft operating system, <b>Windows NT</b> (where the NT stands for
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp That did not quite work out either, so Microsoft came out with yet another version of Windows 98 called <b>Windows Me (Millennium Edition)</b>. In 2001, a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Still the spawning of versions continued unabated. After Windows 2000,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Then in January 2007, Microsoft finally released the successor to Windows
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp With the arrival of Windows 7, a new and much less resource hungry version
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The other major contender in the personal computer world is UNIX (and its
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As an aside, throughout this book we will use the term <b>x86</b> to refer to all modern processors based on the family of instruction-set architectures that started with
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <b>FreeBSD</b> is also a popular UNIX derivative, originating from the BSD project
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Many UNIX users, especially experienced programmers, prefer a commandbased interface to a GUI, so nearly all UNIX systems support a windowing system
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp An interesting development that began taking place during the mid-1980s is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Network operating systems are not fundamentally different from single-processor operating systems. They obviously need a network interface controller and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A distributed operating system, in contrast, is one that appears to its users as a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp True distributed operating systems require more than just adding a little code
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Communication delays within the network often mean that these (and other)
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Ever since detective Dick Tracy started talking to his ‘‘two-way radio wrist
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp he first true handheld phone appeared in the 1970s and, at roughly one kilogram, was positively featherweight. It was affectionately known as ‘‘the brick.’’
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp While the idea of combining telephony and computing in a phone-like device
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Now that smartphones have become ubiquitous, the competition between the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After all, most smartphones in the first decade after their inception were running <b>Symbian</b> OS. It was the operating system of choice for popular brands like
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp For phone manufacturers, Android had the advantage that it was open source
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp An operating system is intimately tied to the hardware of the computer it runs
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Conceptually, a simple personal computer can be abstracted to a model resembling that of Fig. 1-6. The CPU, memory, and I/O devices are all connected by a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The ‘‘brain’’ of the computer is the CPU. It fetches instructions from memory
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Each CPU has a specific set of instructions that it can execute. Thus an x86
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Yet another register is the <b>PSW (Program Status Word)</b>. This register contains the condition code bits, which are set by comparison instructions, the CPU
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The operating system must be fully aware of all the registers. When time multiplexing the CPU, the operating system will often stop the running program to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To improve performance, CPU designers have long abandoned the simple
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Even more advanced than a pipeline design is a <b>superscalar</b> CPU, shown in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Most CPUs, except very simple ones used in embedded systems, have two
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp User programs always run in user mode, which permits only a subset of the instructions to be executed and a subset of the features to be accessed. Generally, all
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To obtain services from the operating system, a user program must make a <b>system call</b>, which traps into the kernel and invokes the operating system. The TRAP
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp It is worth noting that computers have traps other than the instruction for executing a system call. Most of the other traps are caused by the hardware to warn
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Moore’s law states that the number of transistors on a chip doubles every 18
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The abundance of transistors is leading to a problem: what to do with all of
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The obvious next step is to replicate not only the functional units, but also
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Multithreading has implications for the operating system because each thread
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Beyond multithreading, many CPU chips now hav e four, eight, or more complete processors or cores on them. The multicore chips of Fig. 1-8 effectively carry
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Incidentally, in terms of sheer numbers, nothing beats a modern <b>GPU (Graphics Processing Unit)</b>. A GPU is a processor with, literally, thousands of tiny cores.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The second major component in any computer is the memory. Ideally, a memory should be extremely fast (faster than executing an instruction so that the CPU is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The top layer consists of the registers internal to the CPU. They are made of
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp typically 32 × 32 bits on a 32-bit CPU and 64 × 64 bits on a 64-bit CPU. Less than
1 KB in both cases. Programs must manage the registers (i.e., decide what to keep
in them) themselves, in software.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Next comes the cache memory, which is mostly controlled by the hardware.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Caching plays a major role in many areas of computer science, not just caching
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Not every question is relevant to every caching situation. For caching lines of main
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Caches are such a good idea that modern CPUs have two of them. The first
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp On multicore chips, the designers have to decide where to place the caches. In
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Main memory comes next in the hierarchy of Fig. 1-9. This is the workhorse
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In addition to the main memory, many computers have a small amount of nonvolatile random-access memory. Unlike RAM, nonvolatile memory does not lose
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <b>EEPROM (Electrically Erasable PROM)</b> and <b>flash memory</b> are also nonvolatile, but in contrast to ROM can be erased and rewritten. However, writing
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Flash memory is also commonly used as the storage medium in portable electronic devices. It serves as film in digital cameras and as the disk in portable music
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Yet another kind of memory is CMOS, which is volatile. Many computers use
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Next in the hierarchy is magnetic disk (hard disk). Disk storage is two orders
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A disk consists of one or more metal platters that rotate at 5400, 7200, 10,800
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Each track is divided into some number of sectors, typically 512 bytes per sector. On modern disks, the outer cylinders contain more sectors than the inner ones.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Sometimes you will hear people talk about disks that are really not disks at all,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Many computers support a scheme known as <b>virtual memory</b>, which we will
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The presence of caching and the MMU can have a major impact on performance. In a multiprogramming system, when switching from one program to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The CPU and memory are not the only resources that the operating system
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In many cases, the actual control of the device is complicated and detailed, so
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The other piece is the actual device itself. Devices have fairly simple interfaces, both because they cannot do much and to make them standard. The latter is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp SATA is currently the standard type of disk on many computers. Since the actual device interface is hidden behind the controller, all that the operating system
sees is the interface to the controller, which may be quite different from the interface to the device.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Because each type of controller is different, different software is needed to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To be used, the driver has to be put into the operating system so it can run in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp There are three ways the driver can be put into the kernel. The first way is to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Every controller has a small number of registers that are used to communicate
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp On some computers, the device registers are mapped into the operating system’s address space (the addresses it can use), so they can be read and written like
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Input and output can be done in three different ways. In the simplest method, a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The second method is for the driver to start the device and ask it to give an interrupt when it is finished. At that point the driver returns. The operating system
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Interrupts are very important in operating systems, so let us examine the idea
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Once the CPU has decided to take the interrupt, the program counter and PSW
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The third method for doing I/O makes use of special hardware: a <b></b> chip that can control the flow of bits between memory
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Interrupts can (and often do) happen at highly inconvenient moments, for example, while another interrupt handler is running. For this reason, the CPU has a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The organization of Fig. 1-6 was used on minicomputers for years and also on
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This system has many buses (e.g., cache, memory, PCIe, PCI, USB, SATA, and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The PCIe bus was invented by Intel as a successor to the older <b>PCI</b> bus, which
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Meanwhile, we still have many leg acy devices for the older PCI standard. As
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In this configuration, the CPU talks to memory over a fast DDR3 bus, to an external graphics device over PCIe and to all other devices via a hub over a <b>DMI (Direct Media Interface)</b> bus. The hub in turn connects all the other devices,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Moreover, each of the cores has a dedicated cache and a much larger cache that
is shared between them. Each of these caches introduces another bus.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The <b>USB (Universal Serial Bus)</b> was invented to attach all the slow I/O devices, such as the keyboard and mouse, to the computer. Howev er, calling a modern USB 3.0 device humming along at 5 Gbps ‘‘slow’’ may not come naturally for
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The <b>(Small Computer System Interface)</b>SCSI  bus is a high-performance bus
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To work in an environment such as that of Fig. 1-12, the operating system has
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp So far, so good. The trouble came in when the user bought a sound card and a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp What plug and play does is have the system automatically collect information
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Very briefly, the boot process is as follows. Every PC contains a parentboard
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When the computer is booted, the BIOS is started. It first checks to see how
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The BIOS then determines the boot device by trying a list of devices stored in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The operating system then queries the BIOS to get the configuration information. For each device, it checks to see if it has the device driver. If not, it asks
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems have been around now for over half a century. During this
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp At the high end are the operating systems for mainframes, those room-sized
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The operating systems for mainframes are heavily oriented toward processing
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One level down are the server operating systems. They run on servers, which
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp An increasingly common way to get major-league computing power is to connect multiple CPUs into a single system. Depending on precisely how they are
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp With the recent advent of multicore chips for personal computers, even
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The next category is the personal computer operating system. Modern ones all
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Continuing on down to smaller and smaller systems, we come to tablets,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Embedded systems run on the computers that control devices that are not generally thought of as computers and which do not accept user-installed software.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Networks of tiny sensor nodes are being deployed for numerous purposes.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The sensors are small battery-powered computers with built-in radios. They
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Each sensor node is a real computer, with a CPU, RAM, ROM, and one or
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another type of operating system is the real-time system. These systems are
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A <b>soft real-time system</b>, is one where missing an occasional deadline, while
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Since meeting deadlines is crucial in (hard) real-time systems, sometimes the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The categories of handhelds, embedded systems, and real-time systems overlap
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The smallest operating systems run on smart cards, which are credit-card-sized
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Some smart cards are Java oriented. This means that the ROM on the smart
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Most operating systems provide certain basic concepts and abstractions such as
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A key concept in all operating systems is the <b>process</b>. A process is basically a
...
The <b>address space</b> contains the executable program, the program’s data, and its
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp We will come back to the process concept in much more detail in Chap. 2. For
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When a process is suspended temporarily like this, it must later be restarted in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Thus, a (suspended) process consists of its address space, usually called the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The key process-management system calls are those dealing with the creation
and termination of processes. Consider a typical example. A process called the
<b>command interpreter</b> or shell reads commands from a terminal. The user has justtyped a command requesting that a program be compiled. The shell must now create a new process that will run the compiler. When that process has finished the
compilation, it executes a system call to terminate itself.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp If a process can create one or more other processes (referred to as <b>child processes</b>) and these processes in turn can create child processes, we quickly arrive at
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Other process system calls are available to request more memory (or release
unused memory), wait for a child process to terminate, and overlay its program
with a different one.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Occasionally, there is a need to convey information to a running process that is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When the specified number of seconds has elapsed, the operating system sends
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Each person authorized to use a system is assigned a <b>UID (User IDentification)</b> by the system administrator. Every process started has the UID of the person
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One UID, called the <b>superuser</b> (in UNIX), or <b>Administrator</b> (in Windows),
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp We will study processes and interprocess communication in Chap. 2.</p>

### **1.5.2 Address Spaces**

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Every computer has some main memory that it uses to hold executing programs. In a very simple operating system, only one program at a time is in memory. To run a second program, the first one has to be removed and the second one
placed in memory.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp More sophisticated operating systems allow multiple programs to be in memory at the same time. To keep them from interfering with one another (and with the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The above viewpoint is concerned with managing and protecting the computer’s main memory. A different, but equally important, memory-related issue is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp However, on many computers addresses are 32 or 64 bits, giving an address
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another key concept supported by virtually all operating systems is the file
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To provide a place to keep files, most PC operating systems have the concept
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The process and file hierarchies both are organized as trees, but the similarity
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Every file within the directory hierarchy can be specified by giving its <b>path name</b> from the top of the directory hierarchy, the <b>root directory</b>. Such absolute
...
path for file CS101 is <i>/Faculty/Prof.Brown/Courses/CS101</i>. The leading slash indicates that the path is absolute, that is, starting at the root directory. As an aside, in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp At every instant, each process has a current <b>working directory</b>, in which path
names not beginning with a slash are looked for. For example, in Fig. 1-14, if
<i>/Faculty/Prof.Brown</i> were the working directory, use of the path <i>Courses/CS101</i>
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Before a file can be read or written, it must be opened, at which time the permissions are checked. If the access is permitted, the system returns a small integer
called a <b>file descriptor</b> to use in subsequent operations. If the access is prohibited,
an error code is returned.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another important concept in UNIX is the mounted file system. Most desktop
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp However, the file system on the CD-ROM cannot be used, because there is no
...
mounted on directory <i>b</i>, thus allowing access to files <i>/b/x</i> and <i>/b/y</i>. If directory <i>b</i>
had contained any files they would not be accessible while the CD-ROM was
mounted, since <i>/b</i> would refer to the root directory of the CD-ROM. (Not being
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another important concept in UNIX is the <b>special file</b>. Special files are provided in order to make I/O devices look like files. That way, they can be read and
written using the same system calls as are used for reading and writing files. Two
kinds of special files exist: <b>block special files</b> and <b>character special files</b>. Block special files are used to model devices that consist of a collection of randomly addressable blocks, such as disks. By opening a block special file and reading, say,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The last feature we will discuss in this overview relates to both processes and
files: pipes. A <b>pipe</b> is a sort of pseudofile that can be used to connect two processes, as shown in Fig. 1-16. If processes <i>A</i> and <i>B</i> wish to talk using a pipe, they
must set it up in advance. When process <i>A</i> wants to send data to process <i>B</i>, it writes
on the pipe as though it were an output file. In fact, the implementation of a pipe is
very much like that of a file. Process <i>B</i> can read the data by reading from the pipe
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp All computers have physical devices for acquiring input and producing output.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp mputers contain large amounts of information that users often want to protect and keep confidential. This information may include email, business plans, tax
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As a simple example, just to get an idea of how security can work, consider
...
<b>rwx bits</b>. For example, the protection code <i>rwxr-x--x</i> means that the owner can
<b>r</b>ead, <b>w</b>rite, or e<b>x</b>ecute the file, other group members can read or execute (but not
write) the file, and everyone else can execute (but not read or write) the file. For a
directory, <i>x</i> indicates search permission. A dash means that the corresponding permission is absent.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In addition to file protection, there are many other security issues. Protecting
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The operating system is the code that carries out the system calls. Editors,
...
using a graphical user interface. Many shells exist, including <i>sh, csh, ksh, and bash</i>.
All of them support the functionality described below, which derives from the original shell (<i>sh</i>).</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When any user logs in, a shell is started up. The shell has the terminal as standard input and standard output. It starts out by typing the <b>prompt</b>, a character
such as a dollar sign, which tells the user that the shell is waiting to accept a command. If the user now types</p>

date

<p align="justify">for example, the shell creates a child process and runs the <i>date</i> program as the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The user can specify that standard output be redirected to a file, for example,</p>
...
<p align="justify">which invokes the sort program with input taken from <i>file1</i> and output sent to <i>file2</i>.
The output of one program can be used as the input for another program by
connecting them with a pipe. Thus</p>

cat file1 file2 file3 | sort >/dev/lp

<p align="justify">Invokes the <i>cat</i> program to concatenate three files and send the output to <i>sort</i> to arrange all the lines in alphabetical order. The output of <i>sort</i> is redirected to the file
<i>/dev/lp</i>, typically the printer.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp If a user puts an ampersand after a command, the shell does not wait for it to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Most personal computers these days use a GUI. In fact, the GUI is just a program running on top of the operating system, like a shell. In Linux systems, this
...
possible to replace the standard GUI desktop (<i>Windows Explorer</i>) with a different
program by changing some values in the registry, although few people do this.</p>

### **1.5.7 Ontogeny Recapitulates Phylogeny**

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After Charles Darwin’s book <i>On the Origin of the Species</i> was published, the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Something vaguely analogous has happened in the computer industry. Each
...
the ancient Romans lacked cars is not that they liked walking so much. It is because they did not know how to build cars. Personal computers exist <i>not</i> because
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In particular, it frequently happens that a change in technology renders some
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As a consequence of this impermanence, in this book we will from time to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To make this point clearer, let us consider a simple example. Early computers
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Let us now examine some historical developments in hardware and how they
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As time went on, compilers for languages like FORTRAN and COBOL got
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When microcomputers hit in the early 1980s, the first ones had 4-KB memories and assembly-language programming rose from the dead. Embedded computers often used the same CPU chips as the microcomputers (8080s, Z80s, and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Early mainframes, like the IBM 7090/7094, had no protection hardware, so
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp At least until the first minicomputer showed up—without protection hardware—so multiprogramming was not possible. Although the PDP-1 and PDP-8
had no protection hardware, eventually the PDP-11 did, and this feature led to multiprogramming and eventually to UNIX.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When the first microcomputers were built, they used the Intel 8080 CPU chip,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Now let us look at operating systems. The first mainframes initially had no
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When minicomputers first appeared, they also had no protection hardware and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In all cases, the software development was dictated by technology. The first
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Early mainframes were largely magnetic-tape based. They would read in a program from tape, compile it, run it, and write the results back to another tape. There
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Typical of these new dev elopments was the CDC 6600, introduced in 1964 and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As minicomputers came into use, they eventually also had hard disks. The
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Virtual memory (discussed in Chap. 3) gives the ability to run programs larger
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In all these developments, we see ideas invented in one context and later
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp We hav e seen that operating systems have two main functions: providing
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp We are thus forced to make a choice between (1) vague generalities (‘‘operating systems have system calls for reading files’’) and (2) some specific system
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp We have chosen the latter approach. It’s more work that way, but it gives more
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp It is useful to keep the following in mind. Any single-CPU computer can execute only one instruction at a time. If a process is running a user program in user
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To make the system-call mechanism clearer, let us take a quick look at the read
...
of bytes to read. Like nearly all system calls, it is invoked from C programs by calling a library procedure with the same name as the system call: <i>read</i>. A call from a
C program might look like this:</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp count = read(fd, buffer, nbytes);</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The system call (and the library procedure) return the number of bytes actually
read in <i>count</i>. This value is normally the same as <i>nbytes</i>, but may be smaller, if,
for example, end-of-file is encountered while reading.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp If the system call cannot be carried out owing to an invalid parameter or a disk
<i>error, count</i> is set to −1, and the error number is put in a global variable, <i>errno</i>. Programs should always check the results of a system call to see if an error occurred.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp System calls are performed in a series of steps. To make this concept clearer,
let us examine the read call discussed above. In preparation for calling the <i>read</i> library procedure, which actually makes the read system call, the calling program
first pushes the parameters onto the stack, as shown in steps 1–3 in Fig. 1-17.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp C and C++ compilers push the parameters onto the stack in reverse order for
historical reasons (having to do with making the first parameter to <i>printf</i>, the format string, appear on top of the stack). The first and third parameters are called by
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The library procedure, possibly written in assembly language, typically puts
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp sense that the instruction following it is taken from a distant location and the return
address is saved on the stack for use later.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Nevertheless, the TRAP instruction also differs from the procedure-call instruction in two fundamental ways. First, as a side effect, it switches into kernel mode.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The kernel code that starts following the TRAP examines the system-call number and then dispatches to the correct system-call handler, usually via a table of
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To finish the job, the user program has to clean up the stack, as it does after
...
parameters pushed before the call to <i>read</i>. The program is now free to do whatever
it wants to do next.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In step 9 above, we said ‘‘may be returned to the user-space library procedure’’
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In the following sections, we will examine some of the most heavily used
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To a large extent, the services offered by these calls determine most of what
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As an aside, it is worth pointing out that the mapping of POSIX procedure
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The first group of calls in Fig. 1-18 deals with process management. Fork is a
...
value, which is zero in the child and equal to the child’s <b>PID (Process IDentifier)</b>
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In most cases, after a fork, the child will need to execute different code from
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Now consider how fork is used by the shell. When a command is typed, the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In the most general case, execve has three parameters: the name of the file to
be executed, a pointer to the argument array, and a pointer to the environment
array. These will be described shortly. Various library routines, including <i>execl</i>,
<i>execv, execle</i>, and <i>execve</i>, are provided to allow the parameters to be omitted or
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Let us consider the case of a command such as/p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp cp file1 file2</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp used to copy <i>file1</i> to <i>file2</i>. After the shell has forked, the child process locates and
executes the file cp and passes to it the names of the source and target files.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The main program of <i>cp</i> (and main program of most other C programs) contains the declaration
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp main(argc, argv, envp)
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp where <i>argc</i> is a count of the number of items on the command line, including the
program name. For the example above, <i>argc</i> is 3.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The second parameter, <i>argv</i>, is a pointer to an array. Element <i>i</i> of that array is a
pointer to the <i>i</i>th string on the command line. In our example, <i>argv</i>[0] would point
to the string ‘‘cp’’, <i>argv</i>[1] would point to the string ‘‘file1’’, and <i>argv</i>[2] would
point to the string ‘‘file2’’.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The third parameter of <i>main</i>, envp, is a pointer to the environment, an array of
strings containing assignments of the form <i>name = value</i> used to pass information
...
used to customize how a user wants to perform certain tasks (e.g., the default printer to use). In Fig. 1-19, no environment is passed to the child, so the third parameter of <i>execve</i> is a zero.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp If exec seems complicated, do not despair; it is (semantically) the most complex of all the POSIX system calls. All the other ones are much simpler. As an example of a simple one, consider exit, which processes should use when they are
finished executing. It has one parameter, the exit status (0 to 255), which is returned to the parent via <i>statloc</i> in the waitpid system call.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Processes in UNIX have their memory divided up into three segments: the <b>text segment</b> (i.e., the program code), the <b>data segment</b> (i.e., the variables), and the
<b>stack segment</b>. The data segment grows upward and the stack grows downward,
...
the data segment is to end. This call, however, is not defined by the POSIX standard, since programmers are encouraged to use the <i>malloc</i> library procedure for
dynamically allocating storage, and the underlying implementation of <i>malloc</i> was
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Many system calls relate to the file system. In this section we will look at calls
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To read or write a file, it must first be opened. This call specifies the file name
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The file descriptor returned can then be used for reading or writing. Afterward, the
file can be closed by close, which makes the file descriptor available for reuse on a
subsequent open.
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The most heavily used calls are undoubtedly read and wr ite. We saw read earlier. Wr ite has the same parameters.
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Although most programs read and write files sequentially, for some applications programs need to be able to access any part of a file at random. Associated
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Lseek has three parameters: the first is the file descriptor for the file, the second is a file position, and the third tells whether the file position is relative to the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp For each file, UNIX keeps track of the file mode (regular file, special file, directory, and so on), size, time of last modification, and other information. Programs can ask to see this information via the stat system call. The first parameter
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In this section we will look at some system calls that relate more to directories
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To see how link works, consider the situation of Fig. 1-21(a). Here are two
users, <i>ast</i> and <i>jim</i>, each having his own directory with some files. If <i>ast</i> now executes a program containing the system call</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp link("/usr/jim/memo", "/usr/ast/note");</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp the file <i>memo</i> in <i>jim’s</i> directory is now entered into <i></i>ast’s directory under the name
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp As we have mentioned earlier, the mount system call allows two file systems to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp By executing the mount system call, the USB file system can be attached to the
root file system, as shown in Fig. 1-22. A typical statement in C to mount is</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp mount("/dev/sdb0", "/mnt", 0);</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp where the first parameter is the name of a block special file for USB drive 0, the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After the mount call, a file on drive 0 can be accessed by just using its path
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A variety of other system calls exist as well. We will look at just four of them
here. The chdir call changes the current working directory. After the call

</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp chdir("/usr/ast/test");
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp an open on the file xyz will open <i>/usr/ast/test/xyz</i>. The concept of a working directory eliminates the need for typing (long) absolute path names all the time.
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In UNIX every file has a mode used for protection. The mode includes the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp chmod("file", 0644);
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The kill system call is the way users and user processes send signals. If a process is prepared to catch a particular signal, then when it arrives, a signal handler isrun. If the process is not prepared to handle a signal, then its arrival kills the process (hence the name of the call).
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp POSIX defines a number of procedures for dealing with time. For example,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp So far we have focused primarily on UNIX. Now it is time to look briefly at
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp With Windows, the situation is radically different. To start with, the library
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The number of Win32 API calls is extremely large, numbering in the thousands. Furthermore, while many of them do invoke system calls, a substantial number are carried out entirely in user space. As a consequence, with Windows it is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The Win32 API has a huge number of calls for managing windows, geometric
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Even introducing all the Win32 API calls here is out of the question, so we will
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Let us now briefly go through the list of Fig. 1-23. CreateProcess creates a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The next six calls operate on files and are functionally similar to their UNIX
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  Windows has directories and they are created with CreateDirector y and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One last note about Win32 is perhaps worth making. Win32 is not a terribly
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Now that we have seen what operating systems look like on the outside (i.e.,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp By far the most common organization, in the monolithic approach the entire
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To construct the actual object program of the operating system when this approach is used, one first compiles all the individual procedures (or the files containing the procedures) and then binds them all together into a single executable
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Even in monolithic systems, however, it is possible to have some structure. The
...
to be carried out. After that, it indexes into a table that contains in slot <i>k</i> a pointer
to the procedure that carries out system call <i>k</i> (step 7 in Fig. 1-17).</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This organization suggests a basic structure for the operating system:</p>

1. A main program that invokes the requested service procedure.
2. A set of service procedures that carry out the system calls.
3. A set of utility procedures that help the service procedures

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In this model, for each system call there is one service procedure that takes care of
...
Libraries)</b>. They hav e file extension <i>.dll</i> and the <i>C:\Windows\system32</i> directory
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A generalization of the approach of Fig. 1-24 is to organize the operating system as a hierarchy of layers, each one constructed upon the one below it. The first
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The system had six layers, as shown in Fig. 1-25. Layer 0 dealt with allocation
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Layer 1 did the memory management. It allocated space for processes in main
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Layer 2 handled communication between each process and the operator console (that is, the user). On top of this layer each process effectively had its own operator console. Layer 3 took care of managing the I/O devices and buffering the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A further generalization of the layering concept was present in the MULTICS
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Whereas the THE layering scheme was really only a design aid, because all the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp With the layered approach, the designers have a choice where to draw the kernel-user boundary. Traditionally, all the layers went in the kernel, but that is not
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Various researchers have repeatedly studied the number of bugs per 1000 lines
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Many microkernels have been implemented and deployed for decades (Haertig
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The MINIX 3 microkernel is only about 12,000 lines of C and some 1400 lines
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Outside the kernel, the system is structured as three layers of processes all running in user mode. The lowest layer contains the device drivers. Since they run in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp the kernel to do the write. This approach means that the kernel can check to see
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Above the drivers is another user-mode layer containing the servers, which do
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One interesting server is the <b>reincarnation server</b>, whose job is to check if the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The system has many restrictions limiting the power of each process. As mentioned, drivers can touch only authorized I/O ports, but access to kernel calls is also
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp An idea somewhat related to having a minimal kernel is to put the <b>mechanism</b> for doing something in the kernel but not the <b>policy</b>. To make this point better,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A slight variation of the microkernel idea is to distinguish two classes of processes, the <b>servers</b>, each of which provides some service, and the <b>clients</b>, which use
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Communication between clients and servers is often by message passing. To
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp An obvious generalization of this idea is to have the clients and servers run on
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Increasingly many systems involve users at their home PCs as clients and large
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The initial releases of OS/360 were strictly batch systems. Nevertheless, many
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This system, originally called CP/CMS and later renamed VM/370 (Seawright
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The heart of the system, known as the <b>virtual machine monitor</b>, runs on the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Because each virtual machine is identical to the true hardware, each one can
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When a CMS program executed a system call, the call was trapped to the operating system in its own virtual machine, not to VM/370, just as it would be were it
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In its modern incarnation, z/VM is usually used to run multiple complete operating systems rather than stripped-down single-user systems like CMS. For example, the zSeries is capable of running one or more Linux virtual machines along
with traditional IBM operating systems.</p>

**Virtual Machines Rediscovers**

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp While IBM has had a virtual-machine product available for four decades, and a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp First the needs. Many companies have traditionally run their mail servers, Web
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Virtualization is also popular in the Web hosting world. Without virtualization,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another use of virtualization is for end users who want to be able to run two or
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp While no one disputes the attractiveness of virtual machines today, the problem
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This situation changed as a result of several academic research projects in the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Some of these early research projects improved the performance over interpreters like Bochs by translating blocks of code on the fly, storing them in an internal cache, and then reusing them if they were executed again. This improved the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The next step in improving performance was to add a kernel module to do
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In practice, the real distinction between a type 1 hypervisor and a type 2 hypervisor is that a type 2 makes uses of a <b>host operating system</b> and its file system to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp After a type 2 hypervisor is started, it reads the installation CD-ROM (or CDROM image file) for the chosen <b>guest operating system</b> and installs the guest OS
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp When the guest operating system is booted, it does the same thing it does on
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A different approach to handling control instructions is to modify the operating
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Another area where virtual machines are used, but in a somewhat different
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Rather than cloning the actual machine, as is done with virtual machines, another strategy is partitioning it, in other words, giving each user a subset of the resources. Thus one virtual machine might get disk blocks 0 to 1023, the next one
might get blocks 1024 to 2047, and so on.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp At the bottom layer, running in kernel mode, is a program called the <b>exokernel</b>
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The advantage of the exokernel scheme is that it saves a layer of mapping. In
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems are normally large C (or sometimes C++) programs consisting of many pieces written by many programmers. The environment used for
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp This is not a guide to C, but a short summary of some of the key differences
between C and languages like <b>Python</b> and especially Java. Java is based on C, so
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp One feature C has that Java and Python do not is explicit pointers. A <b>pointer</b>
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp which declare <i>c1</i> and <i>c2</i> to be character variables and <i>p</i> to be a variable that points
...
pointed to by <i>p</i> to the variable <i>c2</i>, so after these statements are executed, c2 also
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Some things that C does not have include built-in strings, threads, packages,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp An operating system project generally consists of some number of directories,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
which allows the programmer to name constants, so that when <i>BUFFER_SIZE</i> is
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp which allows the programmer to write</p>

i = max(j, k+1)

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp and get</p>

i = (j > k+1 ? j : k+1)

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp to store the larger of <i>j</i> and <i>k+1</i> in <i>i</i>. Headers can also contain conditional compilation, for example</p>
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp which compiles into a call to the function intel <i>int_ack</i> if the macro X86 is defined
...
<i>#include</i> directive. There are also many header files that are common to nearly
ev ery .c and are stored in a central directory.</p>

### **1.8.3 Large Programming Projects**

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To build the operating system, each <i>.c</i> is compiled into an <b>object file</b> by the C
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The first pass of the C compiler is called the <b>C preprocessor</b>. As it reads each
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Since operating systems are very large (fiv e million lines of code is not
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Fortunately, computers are very good at precisely this sort of thing. On UNIX
systems, there is a program called <i>make</i> (with numerous variants such as <i>gmake</i>,
pmake, etc.) that reads the <i>Makefile</i>, which tells it which files are dependent on
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Once all the <i>.o</i> files are ready, they are passed to a program called the <b>linker</b> to
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Once the operating system binary has been linked, the computer can be
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In all cases, the operating system code is directly executed by the hardware,
with no interpreter and no just-in-time compilation, as is normal with Java.</p>

## **1.9 RESEARCH ON OPERATING SYSTEMS**

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Computer science is a rapidly advancing field and it is hard to predict where it
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp For example, when President Eisenhower set up the Dept. of Defense’s Advanced Research Projects Agency (ARPA) in 1958, he was trying to keep the
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Research in operating systems has also led to dramatic changes in practical
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In this section and in comparable sections throughout the book, we will take a
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Virtually all operating systems researchers realize that current operating systems are massive, inflexible, unreliable, insecure, and loaded with bugs, certain
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp We hav e now completed our introduction and bird’s-eye view of the operating
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Chapter 2 is about processes and threads. It discusses their properties and how
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp In Chap. 3 we will study address spaces and their adjunct, memory management, in detail. The important topic of virtual memory will be examined, along
with closely related concepts such as paging and segmentation.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Then, in Chap. 4, we come to the all-important topic of file systems. To a considerable extent, what the user sees is largely the file system. We will look at both
the file-system interface and the file-system implementation.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Input/Output is covered in Chap. 5. The concepts of device independence and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp A hugely important subject is operating system security, which is covered in
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Next we have some case studies of real operating systems. These are UNIX,
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp To avoid any confusion, it is worth stating explicitly that in this book, as in
...
units greater than 1 capitalized. Thus a 1-TB database occupies 10^12 bytes of storage and a 100-psec (or 100-ps) clock ticks every 10−10 seconds. Since milli and
...
measuring memory sizes have slightly different meanings. There kilo means 2^10
(1024) rather than 10^3 (1000) because memories are always a power of two. Thus a
1-KB memory contains 1024 bytes, not 1000 bytes. Similarly, a 1-MB memory
contains 2^20 (1,048,576) bytes and a 1-GB memory contains 2^30 (1,073,741,824)
...
GB for 2^10, 2^20, and 2^30 bytes respectively, and the symbols Kbps, Mbps, and Gbps
for 10^3, 10^6, and 10^9 bits/sec, respectively.</p>

## **1.12 SUMMARY**

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems can be viewed from two viewpoints: resource managers and
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems have a long history, starting from the days when they replaced the operator, to modern multiprogramming systems. Highlights include
early batch systems, multiprogramming systems, and personal computer systems.</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Since operating systems interact closely with the hardware, some knowledge
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The basic concepts on which all operating systems are built are processes,
memory management, I/O management, the file system, and security. Each of these
will be treated in a subsequent chapter.
</p>

<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp The heart of any operating system is the set of system calls that it can handle.
...
<p align="justify">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Operating systems can be structured in several ways. The most common ones
